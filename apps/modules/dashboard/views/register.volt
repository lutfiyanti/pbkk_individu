            ...
            <form action="register" method="post" role="form" >
              <div class="form-row">
                ...
                <div class="form-group" >
                  <input type="text" name="email" class="form-control" id="email" placeholder="Email" data-rule="email" data-msg="Masukkan email valid" />
                  <div class="validate"></div>
                </div>
              <div class="form-group">
                <input type="text" class="form-control" name="username" id="password" placeholder="Nama" data-rule="minlen:4" data-msg="Masukkan nama anda" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
                <input type="password" class="form-control" name="password" id="password" placeholder="Password" data-rule="minlen:4" data-msg="Masukkan password anda" />
                <div class="validate"></div>
              </div>
